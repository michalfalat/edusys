...
import { ISubscriptionDetailResponse, ISubscriptionFilterRequest, ISubscriptionEditRequest, Pagination } from '@edusys/model';
import { Observable } from 'rxjs';
import { deleteSubscriptionUrl, editSubscriptionUrl, fetchSubscriptionDetailUrl, fetchSubscriptionListUrl } from './subscription.endpoints';
...
export class SubscriptionService {
  ...
  fetchSubscriptionList = (request: ISubscriptionFilterRequest): Observable<Pagination<ISubscriptionDetailResponse>> => {
    return this.httpClient.post<Pagination<ISubscriptionDetailResponse>>(fetchSubscriptionListUrl(this.baseUrl()), request);
  };
